...
@Entity
@Table(name = "VENTAS") // nombre real de la tabla en Oracle (Hibernate la busca al validar/crear el esquema)
@AllArgsConstructor
@NoArgsConstructor
...
public class Venta {
    ...
    public void agregarDetalle(DetalleVenta detalleVenta){
        if (detalleVenta == null)
            throw new IllegalArgumentException("El detalle dev la venta es requerido");
