package com.nhernandez.almacen.exceptions;

import com.nhernandez.almacen.dto.CustomErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handlerResponseEntity(ConstraintViolationException e){
        return ResponseEntity.badRequest().body(new CustomErrorResponse(HttpStatus.BAD_REQUEST.value(),
                "Violacion de registro: " + e.getMessage()));
    }
